...
const THEMES = {
    day: {
        ...
        logo:         { background: 'linear-gradient(135deg, #15803d, #166534)', boxShadow: '0 0 20px rgba(22,163,74,0.3)' },
        brandName:    { color: '#14532d' },
        eventName:    { color: '#15803d' },
        clockTime:    { color: '#14532d', textShadow: 'none' },
        ...
        liveDot:      { background: '#16a34a', boxShadow: '0 0 8px rgba(22,163,74,0.9)' },
        liveText:     { color: '#15803d' },
        heroIconWrap: { background: 'rgba(22,163,74,0.1)', border: '1px solid rgba(22,163,74,0.2)' },
        heroNumber:   { color: '#15803d', textShadow: '0 2px 20px rgba(22,163,74,0.2)' },
    ...
    night: {
        ...
        bgGlow1:      { background: 'radial-gradient(ellipse, #14532d 0%, transparent 70%)', opacity: 0.5 },
        bgGlow2:      { background: 'radial-gradient(ellipse, #14532d 0%, transparent 70%)', opacity: 0.3 },
        header:       { borderBottomColor: 'rgba(255,255,255,0.07)', background: 'rgba(4,13,7,0.6)' },
        logo:         { background: 'linear-gradient(135deg, #15803d, #166534)', boxShadow: '0 0 20px rgba(34,197,94,0.25)' },
        brandName:    { color: '#fff' },
...
const GLOBAL_STYLES = `
    ...
    .mon   { font-family: 'Outfit', sans-serif; }
